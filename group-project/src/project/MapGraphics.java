...
public class MapGraphics extends GraphicsPane {
	...
	private void initializeObjects() {
		...
		levelOne = new Level(new GImage("media/images/level1.png", 1 * 175, 1 * 175), 1, levelOneEnemy, false, new Reward(program.getPlayer(), 10, new Slash()));
		levelTwo = new Level(new GImage("media/images/level2.png", 2 * 175, 1 * 175), 2, levelTwoEnemy, false, new Reward(program.getPlayer(), 20, new Slash()));
		levelThree = new Level(new GImage("media/images/level3.png", 3 * 175, 1 * 175), 3, levelThreeEnemy, false, new Reward(program.getPlayer(), 30, null));
		levelFour = new Level(new GImage("media/images/level4.png", 4 * 175, 1 * 175), 4, levelFourEnemy, false, new Reward(program.getPlayer(), 40, new Split()));
		levelFive = new Level(new GImage("media/images/level5.png", 5 * 175, 1 * 175), 5, levelFiveEnemy, false, new Reward(program.getPlayer(), 50, null));
		levelSix = new Level(new GImage("media/images/level6.png", 1 * 175, 2 * 175), 6, levelSixEnemy, false, new Reward(program.getPlayer(), 60, new LargeManaPotion()));
		levelSeven = new Level(new GImage("media/images/level7.png", 2 * 175, 2 * 175), 7, levelSevenEnemy, false, new Reward(program.getPlayer(), 70, null));
		levelEight = new Level(new GImage("media/images/level8.png", 3 * 175, 2 * 175), 8, levelEightEnemy, false, new Reward(program.getPlayer(), 80, new LargeHealthPotion()));
		levelNine = new Level(new GImage("media/images/level8.png", 4 * 175, 2 * 175), 9, levelNineEnemy, false, new Reward(program.getPlayer(), 90, null));
		levelTen = new Level(new GImage("media/images/level8.png", 5 * 175, 2 * 175), 10, levelTenEnemy, false, new Reward(program.getPlayer(), 100, new LifeSteal()));
		levelEleven = new Level(new GImage("media/images/level8.png", 1 * 175, 3 * 175), 11, levelElevenEnemy, false, new Reward(program.getPlayer(), 110, null));
		levelTwelve = new Level(new GImage("media/images/level8.png", 2 * 175, 3 * 175), 12, levelTwelveEnemy, false, new Reward(program.getPlayer(), 120, new Stab()));
		levelThirteen = new Level(new GImage("media/images/level8.png", 3 * 175, 3 * 175), 13, levelThirteenEnemy, false, new Reward(program.getPlayer(), 130, null));
		levelFourteen = new Level(new GImage("media/images/level8.png", 4 * 175, 3 * 175), 14, levelFourteenEnemy, false, new Reward(program.getPlayer(), 140, new ManaRevive()));
		levelFifteen = new Level(new GImage("media/images/level8.png", 5 * 175, 3 * 175), 15, levelFifteenEnemy, false, new Reward(program.getPlayer(), 150, null));
		levelSixteen = new Level(new GImage("media/images/level8.png", 1 * 175, 4 * 175), 16, levelSixteenEnemy, false, new Reward(program.getPlayer(), 160, new Revive()));
		levelSeventeen = new Level(new GImage("media/images/level8.png", 2 * 175, 4 * 175), 17, levelSeventeenEnemy, false, new Reward(program.getPlayer(), 170, null));
		levelEighteen = new Level(new GImage("media/images/level8.png", 3 * 175, 4 * 175), 18, levelEighteenEnemy, false, new Reward(program.getPlayer(), 180, new SoulSteal()));
		levelNineteen = new Level(new GImage("media/images/level8.png", 4 * 175, 4 * 175), 19, levelNineteenEnemy, false, new Reward(program.getPlayer(), 190, null));
		levelTwenty = new Level(new GImage("media/images/level8.png", 5 * 175, 4 * 175), 20, levelTwentyEnemy, false, new Reward(program.getPlayer(), 200, new Suicide()));
